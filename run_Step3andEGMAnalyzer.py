...
'''
 = cms.EDProducer("PFClusterProducer",
    ...
    initialClusteringStep = cms.PSet(
        ...
        pid_threshold = cms.double(0.1),  
        thresholdsByDetector = cms.VPSet(),
        tracksterSrc = cms.InputTag("ticlTrackstersMerge")
'''

##### analyse reco
process.ana = cms.EDAnalyzer('HGCalEGMAnalysis',
#                             detector = cms.string("all"),
#                             inputTag_HGCalMultiCluster = cms.string("ticlMultiClustersFromTrackstersMerge"),
                             inputTag_Reco = cms.string("TEST"),
#                             inputTag_Reco = cms.string("RECO"),
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("file:v4pho8pr.root")
